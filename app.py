...
- Change 1 : Tooltip is added
- Change 2 : Points in scatter plot are changed to circles
- Change 3 : Title is added
- Change 4 : Size and color is added
- Change 5 : Mean of points on y-axis is added
""")
scatter = alt.Chart(df, title = 'scatter plot').mark_circle().encode(x = 'x',y = 'y',size = 'y',
                           color = 'y', tooltip = ['x','y'])
mean = (
    alt.Chart(df)
    .mark_rule()
...
st.altair_chart(scatter+mean, use_container_width=True)
